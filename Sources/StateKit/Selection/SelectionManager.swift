...
public protocol SelectionManager<Element> {
     ...
     */
    func handleSelection(from collection: some Collection<Element>)
}

// MARK: - CallbackSelectionManager

public final class CallbackSelectionManager<Element: Identifiable>: SelectionManager {
    ...
    public func handleSelection(from collection: some Collection<Element>) {
        guard let selectedID,
              let onSelectionChange else {
            return
        }
